...
5. Invalidation & Asymmetry: Define structural breakdown level (Stop Loss) strictly below support floors to guarantee Risk-to-Reward (R:R) >= 2:1.

Conclude with a structured Markdown table summarizing: Metric / Level, Timeframe (1D/1H), Price / Value, Bias (Bullish/Bearish/Neutral), and Technical Implication (Support Floor / Invalidation / Neural Target)."""
            + get_language_instruction()
        )
