...
3. **Limit Accumulation on Dips**: If price is pulling back, identify the optimal **Limit Accumulation Zone ($XXX)** anchored near structural support (Fibonacci levels, 20D/60D swing floors, or tactical support) with R:R >= 2:1.
